    ...
    class LR_Sharing_Install {
        ...
        public function __construct() {
            ...
            if ($lr_js_in_footer) {
                ...
                add_action('wp_footer', array($this, 'enqueue_Lrshare_scripts'), 1);
                add_action('wp_footer', array($this, 'enqueue_Lr_Social_Share_Script'), 1);
            } else {
