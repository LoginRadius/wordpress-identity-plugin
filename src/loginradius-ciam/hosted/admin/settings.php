            ...
            ?>
                ...
                <label class="active-toggle">                
                    ...
                    <span class="active-toggle-name">
                        <?php _e('Enable Auth Studio.', 'CIAM'); ?> 
                    </span>
                </label>   
                <span class="hostedpage-tooltip ciam-tooltip" data-title="<?php _e('From here, Auth Studio functionality can be enabled. It is recommended that SSO should be enabled with the Auth Studio.', 'ciam-plugin-slug'); ?>">
