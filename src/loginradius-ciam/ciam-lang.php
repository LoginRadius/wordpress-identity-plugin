...
define('LOGIN_BY_USERNAME_MSG',  'Passwordless login link has been sent to your provided email address, check email for further instruction.');
...
define('RESET_PASSWORD_MSG',  'Password has been reset successfully.');
