        ...
        public function render_options_page() {
            ...
            try {
                $config = $configAPI->getConfigurations();
                    if(isset($config->IsPhoneLogin) && $config->IsPhoneLogin) {
                        ...
                        <div class="ciam_options_container">  
                            ...
                            <div class="active-row">
                                ...
                                <table class="wp-list-table widefat">
                                    ...
                                    <!-- <tr>
                                        <td style="width: 15%;"><span class="ciam_property_title custom_ciam_property_title"><?php _e('Custom Domain', 'CIAM'); ?></span></td>
                                        <td style="padding-right: 50%;"><input type="text" id="custom_domain" class="active-row-field custom_active-row-field" name="ciam_api_settings[custom_domain]" value="<?php echo ( isset($ciam_credentials['custom_domain']) && !empty($ciam_credentials['custom_domain']) ) ? $ciam_credentials['custom_domain'] : ''; ?>" autofill='off' autocomplete='off' /></td>
                                       </tr><br> 
                                       <tr><td colspan="2"><p style="margin-left: 169px; margin-top: -15px;"><?php _e('Here you can enter your custom domain for LoginRadius API calling. It will replace the default API domain.', 'lr-plugin-slug'); ?></p></td>
                                    </tr>                                       -->
                                </table>
