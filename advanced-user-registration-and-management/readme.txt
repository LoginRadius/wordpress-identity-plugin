...
This plugin enables User Registration and Management for your WordPress website. Along with that it also captures users’ profile data, with their permission of course, and automatically creates a profile. The plugin can also feed the data into your existing email software such as MailChimp or any other marketing, sales or analytics software.
