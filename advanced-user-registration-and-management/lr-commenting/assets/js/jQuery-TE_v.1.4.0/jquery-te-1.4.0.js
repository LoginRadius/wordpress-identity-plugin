...
(function($){		
	$.fn.jqte = function(options){
		...
		return this.each(function(){
			...
			jQTE.html('<div class="' + vars.css + '_editor"></div>');
			$('.lr-editor-format-container').html('<div class="' + vars.css + '_toolbar" role="toolbar" unselectable></div><div class="' + vars.css + '_linkform" style="display:none" role="dialog">');

			//var toolbar			= jQTE.find('.'+vars.css+"_toolbar"); // the toolbar variable
			var toolbar			= $( '.' + vars.css + '_toolbar' ); // the toolbar variable
