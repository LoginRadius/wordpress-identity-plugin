...
class WP_LR_Sailthru_Client extends LR_Sailthru_Client {
    ...
    function httpRequestCurl($url, array $data, $method = 'POST', $options = array()) {
        ...
        if ( isset( $reply ) ) {
            if ( is_wp_error( $reply ) ) {
                throw new LR_Sailthru_Client_Exception("Bad response received from $url: " . $reply->get_error_message() );
            } else {
            ...
            throw new LR_Sailthru_Client_Exception( 'A reply was never generated.' );
        }
